        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Management Category</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col-xl-7 mx-auto">
                    <h6 class="mb-0 text-uppercase">Management Category</h6>
                    <hr>
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <form class="row g-3" method="POST"
                                action="{{ route('categories.update', [$getCategoryById->id]) }}"
                                ...
                                <div class="col-md-12">
                                    <img src="{{ !empty($getCategoryById->image) ? asset('upload/categories/' . $getCategoryById->image) : asset('admin_backend/assets/images/no_image.jpg') }}"
