                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="header-info">
                        <ul>
                            ...
                            <li><a href="{{ route('account') }}">My Cart</a></li>
                ...
                <div class="header-right">
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            @if (!empty(Auth::user()))
                                @php
                                    $getUserById = App\Models\User::find(Auth::user()->id);
                                @endphp
                                <div class="header-action-icon-2">
                                    ...
                                    <a href="{{ route('account') }}"><span
                                            class="lable ml-0">{{ $getUserById->name }}</span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            <li>
                                                <a href="{{ route('account') }}"><i class="fi fi-rs-user mr-10"></i>My
                                                    Account</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <form action="{{ route('logout') }}" method="POST"
                                                    ...
                                                    <a onclick="document.getElementById('form-logout').submit();">
                                                        <i class="fi fi-rs-sign-out mr-10">
                                                        </i>Sign
                                                        out</a>
                                                </form>
                                            </li>
